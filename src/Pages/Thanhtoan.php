            ...
            <div class="main__context flex " style="justify-content: space-between; width: 800px;">
                            ...
                            <div class="section__content ">
                                <div class="fieldset ">
                                    ...
                                    <div class="field flex w-full " style="justify-content: space-between;">
                                        ...
                                        <input class="field__input" style="" type="text" name="number" id="" placeholder="Số điện thoại" require>
                                        <div class="" style="">
                                ...
                                <div class="fieldset h-80 " style="width: 370px; ">
                                    ...
                                    <div class="field w-full " data-bind-class="{'field--show-floating-label': note}">
                                        <div class="field__input-wrapper w-full">
                                            ...
                                            <textarea class="" style="width: 370px; min-height:100px;border: 1px solid #171617; padding-left: 12px;" name="note" id="note" class="field__input" data-bind="note" placeholder="Ghi chú" require></textarea>
                                        </div>
                ...
                <div class="w-1/2 ">
                    <div class="w-full">
                        ...
                        <div>
                            <div class="" style="padding: 12px 20px;font-size:14px; margin:0px 0px 16px; border:1px solid; margin-bottom:1rem; border-radius:0.25rem;">
                                        <div >
                    ...
                    <div class="">
                        ...
                        <div>
                            <div class="" style=" display:flex;align-items:center; padding: 12px 20px;font-size:14px; margin:0px 0px 16px ; border:1px solid; border-radius:0.25rem;">
