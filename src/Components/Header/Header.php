    ...
    <header class="header__header">
        <div class="header__box">
            <div class="header__logo">
                <img class="header__img" src=".././Image/logo.png" alt="logo">
            </div>
        ...
        <nav class="sm:h-8">
                    ...
                    <div class="flex sm:items-stretch sm:justify-start h-9">
                        <div class="hidden m-0 sm:ml-6 sm:block">
                            <div class="flex space-x-4 h-full">
                                ...
                                <a href="/"
                                    class="bg-sky-500 active:bg-sky-500 text-white py-2 text-sm font-medium w-20 text-center"
            ...
            <div class="sm:hidden absolute top-30 left-0 z-10 w-full bg-sky-1000 text-white" id="mobile-menu">
                <div class="space-y-1 px-2 pt-2 pb-3 hidden" id="nav-mobile">
                    <a href="#" class="bg-sky-500 text-white block px-3 py-2 rounded-md text-base font-medium active:bg-sky-500"
                        aria-current="page">Trang chủ</a>
